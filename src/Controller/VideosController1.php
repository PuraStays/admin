...
class VideosController extends AppController
{
    ...
    public function index()
    {
        ...
        $this->set('videos', $this->Videos->find('all'));
        ...
        if ($this->request->is('post')) {
                ...
                //start of upload video
                 if (!empty($this->request->data['Video']['name'])) {
                        ...
                        $arr_ext = array('avi', 'asf', 'mov', 'avchd', 'avchd', 'mpg', 'mpeg', 'mp4', 'mpeg4', 'wmv'); //set allowed extensions
            ...
            $video['Video'] = "http://mybuccketsfdfsdfs.s3.amazonaws.com/".$fileName;
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if (!empty($this->request->data['Video']['name'])) {
                ...
                //upload video by aws starts here
                        ...
                        $file = $this->request->data['Video']; 
                        $ext = substr(strtolower(strrchr($file['name'], '.')), 1); //get the extension
                        $arr_ext = array('avi', 'asf', 'mov', 'avchd', 'avchd', 'mpg', 'mpeg', 'mp4', 'mpeg4', 'wmv'); //set 
                        $setNewFileName = time() . "_" . rand(000000, 999999);
