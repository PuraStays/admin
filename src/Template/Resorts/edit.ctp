            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <?= $this->Form->input('Alt', array('label'=>'Gallery Alt' ,'type'=>'textarea' ,'class' => 'form-control', 'placeholder' => 'Enter Gallery Alts'));?>
                    </div>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <?= $this->Form->input('room_id', array('label'=>'Room Types', 'type' => 'select', 'class' => 'form-control select2', 'multiple' => 'multiple', 'options' => $rooms, ));?>
                    </div>
                    <!--
                    <div class="form-group">
