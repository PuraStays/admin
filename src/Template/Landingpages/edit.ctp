 <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
		    ...
		    <div class="form-group">
                        <?= $this->Form->input('url', array('label' => 'Key','type'=>'text' ,'class' => 'form-control', 'placeholder' => 'Enter key'));?>
                    </div>

		    <div class="form-group">
                        <?= $this->Form->input('abc', array('label' => 'URL','type'=>'text', 'readonly'=>'readonly', 'value'=>'www.purastays.com/promotions/adds/landing-page.php?u='.$landingpage['url'], 'class' => 'form-control', 'placeholder' => 'URL'));?>
                    </div>
