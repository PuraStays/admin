        ...
        <section class="content-header">
          <h1>
			...
			<div class="col-xs-4">
              <div class="box">
                <div class="box-header with-border">
                    <?= $this->Html->link(__('NON CONFIRMED', true), ['action' => 'notConformed'], array('class'=>'btn btn-primary', 'alt'=> 'notConformed')) ?> 
                </div>
...
WHERE a.id = b.userid AND b.status =0 GROUP BY a.id";
