      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?= tab_status(['Resorts', 'Clusters', 'Activities', 'Explorepuras', 'Stayprograms', 'Customers', 'Promotions', 'ResortsRooms', 'Landingpages'], $this->request->params['controller']); ?>" class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu"> 
                  ...
                  <li class="<?php if($this->request->params['controller']=='Landingpages'){ echo 'active'; }?>">
                  <?= $this->Html->link(__('<i class="fa fa-circle-o"></i> '.'Landingpages', true), ['action' => 'index', 'controller'=>'Landingpages'], ['escape'=>false]); ?>



                  <li class="<?php if($this->request->params['controller']=='ResortsRooms'){ echo 'active'; }?>">
                  <?= $this->Html->link(__('<i class="fa fa-circle-o"></i> '.'ResortsRooms', true), ['action' => 'index', 'controller'=>'ResortsRooms'], ['escape'=>false]); ?>
                  </li>
