...
class ActivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'Activity_Name' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'About_Activity_Title' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'About_Activity_Description' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'About_Activity_Title' => 'Lorem ipsum dolor sit amet',
            'About_Activity_Description' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
            'feature_id' => 'Lorem ipsum dolor sit amet',
            'testimonial_id' => 'Lorem ipsum dolor sit amet',
            'gallery_id' => 'Lorem ipsum dolor sit amet',
            'Status' => 1,
            'DOC' => '2016-01-17 17:53:04',
            'DOU' => '2016-01-17 17:53:04'
        ],
    ];
}
