            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <?= $this->Form->input('Mood', array('label' => 'Mood', 'type' => 'select', 'class' => 'form-control select2', 'multiple' => 'multiple', 'options' => $Mood));?>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <?= $this->Form->input('Total_Activities', array('class' => 'form-control', 'placeholder' => 'Enter Total Activities'));?>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-6">
               ...
               <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <?= $this->Form->input('Rate_Adult_Double_Occ', array('label'=>'Rate Adult Double Occurrence', 'class' => 'form-control', 'placeholder' => 'Enter Rate Adult Double Occurrence'));?>
                    </div>
                    <div class="form-group">
                        <?= $this->Form->input('Rate_Adult_Single_Occ', array('label'=>'Rate Adult Single Occurrence', 'class' => 'form-control', 'placeholder' => 'Enter Rate Adult Single Occurrence'));?>
                    </div>
                    <div class="form-group">
                        <?= $this->Form->input('Rate_Kids', array('label'=>'Rate Adult Single Occurrence', 'class' => 'form-control', 'placeholder' => 'Enter Rate Kids'));?>
                    </div>
