...
<html>
  <head>
    ...
    <title>Pura Stay | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Ex</b>stay</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?= $this->Html->image('../dist/img/user2-160x160.jpg', ['class' => 'user-image', 'alt' => 'User Name']); ?>
                  <span class="hidden-xs">Sangh Deep</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?= tab_status(['Resorts', 'Clusters', 'Activities', 'Explorepuras', 'Stayprograms'], $this->request->params['controller']); ?>" class="treeview">
              <a href="#">
                <i class="fa fa-users"></i> <span>Management</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                  <li class="<?php if($this->request->params['controller']=='Resorts'){ echo 'active'; }?>"><?= $this->Html->link(__('<i class="fa fa-circle-o"></i> '.'Resort', true), ['action' => 'index', 'controller'=>'Resorts'], ['escape'=>false]); ?></li>

                  <li class="<?php if($this->request->params['controller']=='Clusters'){ echo 'active'; }?>"><?= $this->Html->link(__('<i class="fa fa-circle-o"></i> '.'Cluster', true), ['action' => 'index', 'controller'=>'Clusters'], ['escape'=>false]); ?></li>

                  <li class="<?php if($this->request->params['controller']=='Activities'){ echo 'active'; }?>">
                  <?= $this->Html->link(__('<i class="fa fa-circle-o"></i> '.'Activity', true), ['action' => 'index', 'controller'=>'Activities'], ['escape'=>false]); ?>
                  </li>
